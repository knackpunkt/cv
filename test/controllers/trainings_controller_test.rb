...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { antwort: @training.antwort, frage: @training.frage, job_type: @training.job_type } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { antwort: @training.antwort, frage: @training.frage, job_type: @training.job_type } }
